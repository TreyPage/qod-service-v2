...
[pass]
include::{snippets}/source-controller-test/post-sources/auto-description.adoc[]
<br/>

include::{snippets}/source-controller-test/post-sources/auto-authorization.adoc[]

.HTTP sample request
include::{snippets}/source-controller-test/post-sources/http-request.adoc[]
.HTTP sample response
include::{snippets}/source-controller-test/post-sources/http-response.adoc[]
.Request object properties
include::{snippets}/source-controller-test/post-sources/auto-request-fields.adoc[]
.Response object properties
include::{snippets}/source-controller-test/post-sources/auto-response-fields.adoc[]
